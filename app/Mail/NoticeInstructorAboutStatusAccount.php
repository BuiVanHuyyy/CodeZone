<?php
    ...
    class NoticeInstructorAboutStatusAccount extends Mailable
    {
        ...
        public function envelope(): Envelope
        {
            ...
            } elseif ($this->instructor->user->status == 'suspended') {
                return new Envelope(
                    subject: 'Thông báo khóa tài khoản Giảng viên trên CodeZone',
                );
            } else {
                return new Envelope(
                    subject: 'Thông báo từ chối tài khoản Giảng viên trên CodeZone',
                );
            }
        }
        ...
        public function content(): Content
        {
            if ($this->instructor->user->status == 'active') {
                ...
                return new Content(
                    'mail_template.email_notice_instructor_rejected',
                    with: ['instructor' => $this->instructor],
                );
            }
        }
