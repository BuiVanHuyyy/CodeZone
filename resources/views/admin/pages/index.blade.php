    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-xxl-4 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Các giảng viên tiêu biểu</h4>
                    </div>
                    <div class="card-body">
                        <div class="media mb-3 align-items-center border-bottom pb-3">
                            <img class="me-3 rounded-circle" alt="image" width="50" src="{{ asset('admin_assets/images/profile/pic1.jpg') }} ">
                        ...
                        <div class="media mb-3 align-items-center border-bottom pb-3">
                            <img class="me-3 rounded-circle" alt="image" width="50" src="{{ asset('admin_assets/images/profile/pic2.jpg') }} ">
                            <div class="media-body">
                        ...
                        <div class="media mb-3 align-items-center border-bottom pb-3">
                            <img class="me-3 rounded-circle" alt="image" width="50" src="{{ asset('admin_assets/images/profile/pic3.jpg') }} ">
                            <div class="media-body">
                        ...
                        <div class="media mb-3 align-items-center border-bottom pb-3">
                            <img class="me-3 rounded-circle" alt="image" width="50" src="{{ asset('admin_assets/images/profile/pic5.jpg') }} ">
                            <div class="media-body">
            ...
            <div class="col-xl-4 col-lg-4 col-xxl-4 col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <small class="text-success"><i class="fas fa-caret-up"></i> 20% High then last mont</small>
                    </div>
                ...
                <div class="card profile-tab">
                    ...
                    <div class="card-body custom-tab-1">
                        <ul class="nav nav-tabs mb-3">
                            <li class="nav-item"><a href="#my-posts" data-bs-toggle="tab" class="nav-link pb-2 active show">Professors</a></li>
                            <li class="nav-item"><a href="#about-me" data-bs-toggle="tab" class="nav-link pb-2">Librarian</a></li>
                            <li class="nav-item"><a href="#profile-settings" data-bs-toggle="tab" class="nav-link pb-2">Other</a></li>
                        </ul>
                            ...
                            <div id="my-posts" class="tab-pane fade active show">
                                <div class="table-responsive">
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><img src="{{ asset('admin_assets/images/profile/pic1.jpg') }} " class="rounded-circle" width="35" alt=""></td>
                                            <td>Angelica Ramos</td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin_assets/images/profile/pic4.jpg') }}" class="rounded-circle" width="35" alt=""></td>
                                            <td>Cedric Kelly</td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin_assets/images/profile/pic5.jpg') }} " class="rounded-circle" width="35" alt=""></td>
                                            <td>Rhona Davidson</td>
                                            <td><span class="badge badge-rounded badge-warning">Pending</span></td>
                                            <td>08 March 2022</td>
                                            <td>$500</td>
                            ...
                            <div id="about-me" class="tab-pane fade">
                                <div class="table-responsive">
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><img src="{{ asset('admin_assets/images/profile/pic6.jpg') }} " class="rounded-circle" width="35" alt=""></td>
                                            <td>Angelica Ramos</td>
                                            <td><span class="badge badge-rounded badge-success">Paid</span></td>
                                            <td>12 August 2022</td>
                                            <td>$100</td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin_assets/images/profile/pic7.jpg') }} " class="rounded-circle" width="35" alt=""></td>
                                            <td>Bradley Greer</td>
                                            <td><span class="badge badge-rounded badge-danger">Unpaid</span></td>
                                            <td>11 July 2022</td>
                                            <td>$200</td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin_assets/images/profile/pic8.jpg') }} " class="rounded-circle" width="35" alt=""></td>
                                            <td>Cedric Kelly</td>
                                            <td><span class="badge badge-rounded badge-warning">Pending</span></td>
                                            <td>10 May 2022</td>
                                            <td>$400</td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin_assets/images/profile/pic10.jpg') }} " class="rounded-circle" width="35" alt=""></td>
                                            <td>Caesar Vance</td>
                                            <td><span class="badge badge-rounded badge-danger">Unpaid</span></td>
                                            <td>09 April 2022</td>
                                            <td>$300</td>
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin_assets/images/profile/pic9.jpg') }} " class="rounded-circle" width="35" alt=""></td>
                                            <td>Rhona Davidson</td>
                                            <td><span class="badge badge-rounded badge-warning">Pending</span></td>
                                            <td>08 March 2022</td>
                                            <td>$500</td>
                            ...
                            <div id="profile-settings" class="tab-pane fade">
                                <div class="table-responsive">
                                    <table class="table table-responsive-md">
                                        ...
                                        <tr>
                                            <td><img src="{{ asset('admin_assets/images/profile/pic2.jpg') }} " class="rounded-circle" width="35" alt=""></td>
                                            <td>Caesar Vance</td>
                                            <td><span class="badge badge-rounded badge-danger">Unpaid</span></td>
                                            <td>09 April 2022</td>
                                            <td>$300</td>
