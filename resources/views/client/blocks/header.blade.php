...
<header class="rbt-header rbt-header-9">
                                            ...
                                            <div class="inner">
                                                <div class="rbt-admin-profile">
                                                    <div class="admin-thumbnail">
                                                        <img src="{{ Auth::user()->students->avatar ?? asset('client_assets/images/avatar/default-avatar.png') }}"
                                                             alt="User Images"/>
                                                    </div>
                                                    <div class="admin-info">
                                                        <span class="name">{{ Auth::user()->name }}</span>
                                                        <a class="rbt-btn-link color-primary" href="{{ route('student.profile') }}">Trang cá nhân</a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <li>
                                                        <form method="post" action="{{ route('logout') }}">
                                                            ...
                                                            <a onclick="event.preventDefault();
                                                                this.closest('form').submit();" href="{{ route('logout') }}"><i class="feather-log-out"></i><span>Đăng xuất</span></a>
                                                        </form>
                                                    </li>
                                                </ul>
                                            </div>
    ...
    <div
        class="rbt-header-wrapper header-not-transparent header-sticky"
    >
        <div class="container">
            <div
                    ...
                    @if(!Auth::check())
                        <div class="rbt-btn-wrapper">
                            <a class="btn btn-outline-secondary"
                               style=" margin-right: 10px; border-radius: 0; font-size: 15px;" href="{{ route('login') }}">Đăng
                                nhập</a>
                            <a class="btn btn-secondary" style="border-radius: 0; font-size: 15px" href="{{ route('register') }}">Đăng ký</a>
                        </div>
                    @endif
