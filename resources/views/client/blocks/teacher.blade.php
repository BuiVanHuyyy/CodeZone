            ...
            >
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div
                            class="team team-style--bottom variation-2"
                        >
                            <div class="thumbnail">
                                <a
                                    href="{{ route('client.instructor_detail', ['slug' => 'teslug-tt']) }}"
                                ><img
                        ...
                        >
                            <div class="thumbnail">
                                <a
                                    href="{{ route('client.instructor_detail', ['slug' => 'teslug-tt']) }}"
                                ><img
                                        src="{{ asset('client_assets/images/team/team-05.jpg') }}"
                                        alt="Blog Images"
                                    /></a>
                            </div>
                            <div class="content">
                        ...
                        >
                            <div class="thumbnail">
                                <a
                                    href="{{ route('client.instructor_detail', ['slug' => 'teslug-tt']) }}"
                                ><img
                                        src="{{ asset('client_assets/images/team/team-06.jpg') }}"
                                        alt="Blog Images"
                                    /></a>
                            </div>
                            <div class="content">
                    ...
                    <div class="swiper-slide">
                        ...
                        >
                            ...
                            <div class="content">
                                ...
                                <div class="icon-right">
                                    <a
                                        href="{{ route('client.instructor_detail', ['slug' => 'slug-']) }}"
                                    ><i
                                            class="feather-arrow-right"
                                        ></i
                                        ></a>
