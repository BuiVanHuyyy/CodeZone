<footer id="contact"
        class="rbt-footer footer-style-1 bg-color-white overflow-hidden"
>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget">
                        <div class="logo">
                            <a href="index-2.html">
                                <img
                                    src="{{ asset('client_assets/images/logo/logo.png') }}"
                                    alt="Edu-cause"
                                />
                            </a>
                        </div>
                        ...
                        <p class="description mt--20">
                            We’re always in search for talented and
                            motivated people. Don’t be shy introduce
                            yourself!
                        </p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget">
                        ...
                        <form class="newsletter-form mt--20" action="#">
                            ...
                            <p class="description">
                                2000+ Our students are subscribe Around
                                the World.<br/>
                                Don’t be shy introduce yourself!
                            </p>

                            <div
                                class="form-group right-icon icon-email mb--20"
                            >
                                <label for="email"
    ...
    <div class="copyright-area copyright-style-1 ptb--20">
        <div class="container">
            <div class="row align-items-center">
                <div
                    class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12"
                >
