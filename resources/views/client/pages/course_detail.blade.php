...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="content text-start">
                        ...
                        <p class="description">
                            Master Python by building 100 projects in 100
                            days. Learn data science, automation, build
                        ...
                        <ul class="rbt-meta">
                            <li>
                                <i class="feather-calendar"></i>Created at
                                12/2024
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-8">
                    <div class="course-details-content">
                        <div
                            class="rbt-course-feature-box rbt-shadow-box thuumbnail"
                        >
                            <img
                                class="w-100"
                                src="{{ asset('client_assets/images/course/course-01.jpg') }}"
                                alt="Card image"
                            />
                        </div>
                        ...
                        >
                            <div class="rbt-course-feature-inner">
                                ...
                                <div
                                    class="rbt-accordion-style rbt-accordion-02 accordion"
                                >
                                    <div
                                        class="accordion"
                                    ...
                                    >
                                        <div class="accordion-item card">
                                            ...
                                            >
                                                <div
                                                    class="accordion-body card-body pr--0"
                                                >
                                                    <ul
                                                        class="rbt-course-main-content liststyle"
                                                    >
                                                        <li>
                                                            <a
                                                                href="./lesion.html"
                                                            >
                                                                <div
                                                                    class="course-content-left"
                                                                >
                                                                    <i
                                                                        class="feather-play-circle"
                                                                    ></i>
                                                                    <span
                                                                        class="text"
                            ...
                            <div class="about-author border-0 pb--0 pt--0">
                                ...
                                <div class="media align-items-center">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img
                                                src="{{ asset('client_assets/images/testimonial/testimonial-7.jpg') }}"
                                                alt="Author Images"
                                            />
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <div class="author-info">
                                            ...
                                            >
                                            <ul
                                                class="rbt-meta mb--20 mt--10"
                                            >
                                                <li>
                                                    <i
                                                        class="fa fa-star color-warning"
                                                    ></i
                                                    >75,237 Reviews
                                                    <span
                                                        class="rbt-badge-5 ml--5"
                                                    >4.4 Rating</span
                                                    >
                                                </li>
                                                <li>
                                        ...
                                        <div class="content">
                                            <p class="description">
                                                John is a brilliant
                                                educator, whose life was
                                                spent for computer science
                                                and love of nature.
                                            </p>
                        ...
                        <div
                            class="about-author-list rbt-shadow-box featured-wrapper mt--30 has-show-more"
                        >
                            <div class="section-title">
                                <h4 class="rbt-title-style-3">
                                    Featured review
                            ...
                            <div
                                class="has-show-more-inner-content rbt-featured-review-list-wrapper"
                            >
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="content">
                                                <p class="description">
                                                    At 29 years old, my
                                                    favorite compliment is
                                                    being told that I look
                                                    like my mom. Seeing
                                                    myself in her image,
                                                    like this daughter up
                                                    top.
                                                </p>
                                                <ul
                                ...
                                <div class="rbt-course-review about-author">
                                    <div class="media">
                                        <div class="thumbnail">
                                            <a href="#">
                                                <img
                                                    src="{{ asset('client_assets/images/testimonial/testimonial-6.jpg') }}"
                                                    alt="Author Images"
                                                />
                                            </a>
                                        </div>
                                ...
                                <div class="rbt-course-review about-author">
                                    <div class="media">
                                        <div class="thumbnail">
                                            <a href="#">
                                                <img
                                                    src="{{ asset('client_assets/images/testimonial/testimonial-8.jpg') }}"
                                                    alt="Author Images"
                                                />
                                            </a>
                                        </div>
                    ...
                    <div class="related-course mt--60">
                        <div class="row g-5 align-items-end mb--40">
                            ...
                            <div class="col-lg-4 col-md-4 col-12">
                                <div
                                    class="read-more-btn text-start text-md-end"
                                >
                                    <a
                                        class="rbt-btn rbt-switch-btn btn-border btn-sm"
                                        href="#"
                                    >
                                            <span data-text="View All Course"
                                            >View All Course</span
                                            >
                                    </a>
                                </div>
                            </div>
                                ...
                                >
                                    <div class="rbt-card-img">
                                        <a href="course-details.html">
                                            <img
                                                src="{{ asset('client_assets/images/course/course-online-01.jpg') }}"
                                                alt="Card image"
                                            />
                                            <div
                                                class="rbt-badge-3 bg-white"
                                            >
                                                <span>-40%</span>
                                                <span>Off</span>
                                            </div>
                            ...
                            >
                                ...
                                >
                                    <div class="rbt-card-img">
                                        <a href="course-details.html">
                                            <img
                                                src="{{ asset('client_assets/images/course/course-online-02.jpg') }}"
                                                alt="Card image"
                                            />
                                        </a>
                                    </div>
    ...
    <div
        class="rbt-related-course-area bg-color-white pt--60 rbt-section-gapBottom"
    >
        <div class="container">
            <div class="section-title mb--30">
